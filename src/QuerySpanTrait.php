...
trait QuerySpanTrait
{
    ...
    public function addTransactionSpan(LoggedQuery $query, ?string $connectionName = null): void
    {
        ...
        if ($connectionName !== null) {
            ...
            $type = 'mysql';
            switch (true) {
                case $dialect instanceof PostgresSchemaDialect:
                    $type = 'postgresql';
                    break;
                case $dialect instanceof SqliteSchemaDialect:
                    $type = 'sqlite';
                    break;
                case $dialect instanceof SqlserverSchemaDialect:
                    $type = 'mssql';
                    break;
                case $dialect instanceof MysqlSchemaDialect:
                default:
                    break;
            }
        }
